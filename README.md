...
El sistema esta disenado bajo una arquitectura cliente-servidor, donde el frontend desarrollado en React + Vite, se comunica con una API REST construida en Node.js con Express. La persistencia de datos se maneja mediante MySQL como motor de base de datos relacional y Sequelize como ORM, lo que garantiza integridad referencial y consultas eficientes sobre los datos del personal.
